...
// ------------------------- FILTER COLLAPSING ----------------------------
function toggleFilterCollapse(value) {
    value.childNodes[3].classList.toggle('filter-active');
}
function toggleMobileFilterCollapse(value) {
    value.childNodes[3].classList.toggle('mobile-filter-collapse-active');
}
const mobileProductsFilter = document.querySelector('aside.mobile-products-filter');
function toggleMobileProductsFilter() {
    mobileProductsFilter.classList.toggle('mobile-products-filter-active');
}